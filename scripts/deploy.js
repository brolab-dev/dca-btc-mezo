...
async function main() {
    ...
    const contractAddress = await dcaContract.getAddress();
    console.log("DCA Contract deployed to:", contractAddress);
    ...
    const deploymentInfo = {
        ...
        transactionHash: dcaContract.deploymentTransaction().hash
    };
